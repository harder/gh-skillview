...
{
    [Fact]
    public void MinimumVersion_is_2_92_0()
    {
        Assert.Equal(2, GhBinaryLocator.MinimumVersion.Major);
        Assert.Equal(92, GhBinaryLocator.MinimumVersion.Minor);
        Assert.Equal(0, GhBinaryLocator.MinimumVersion.Patch);
    }

    [Theory]
    [InlineData("2.91.0", false)]
    [InlineData("2.91.0-rc.1", false)]
    [InlineData("2.91.1", false)]
