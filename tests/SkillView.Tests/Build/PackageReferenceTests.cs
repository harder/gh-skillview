...
public sealed class PackageReferenceTests
{
    ...
    public void SkillViewCore_UsesTerminalGuiV2()
    {
        ...
        Assert.Contains("""<TerminalGuiVersion Condition="'$(TerminalGuiVersion)' == ''">2.4.2-develop.53</TerminalGuiVersion>""", text);
    ...
    public void SkillViewCore_PairsEditorWithBaseVersion()
    {
        ...
        Assert.Contains("""<TerminalGuiEditorVersion Condition="'$(TerminalGuiEditorVersion)' == ''">2.5.0</TerminalGuiEditorVersion>""", text);
